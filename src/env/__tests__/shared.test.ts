  ...
  it("accepts Google and PostHog env vars when PROD is true", () => {
    expect(
      ...
      WXT_OFFICIAL_SITE_ORIGINS:
        PRODUCTION_EXTENSION_ENV_DEFAULTS.WXT_OFFICIAL_SITE_ORIGINS.split(","),
      WXT_AUTH_COOKIE_DOMAINS: PRODUCTION_EXTENSION_ENV_DEFAULTS.WXT_AUTH_COOKIE_DOMAINS.split(","),
