...
/**
 * Frozen v097 fixtures. Written out in full on purpose: an example file that
 * spreads the previous version is not a snapshot, because editing v096 would
 ...
 * the rename leaves untouched configs byte-for-byte alone. Coverage for
 * configs that *do* hold the old id lives in
 * `migration-scripts/v096-to-v097.test.ts`.
 */
