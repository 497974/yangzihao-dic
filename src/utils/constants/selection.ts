...
export const EXTERNAL_SELECTION_OPEN_EVENT = "yangzihao-dic:external-selection-open"
/** Fired when an external source dismisses its relayed selection. */
export const EXTERNAL_SELECTION_CLEAR_EVENT = "yangzihao-dic:external-selection-clear"
